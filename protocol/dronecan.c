...
{
    if (h&HEALTH_CAN_BUS_OFF) return UAVCAN_PROTOCOL_NODESTATUS_HEALTH_CRITICAL;
    if (h&(HEALTH_PMW_FAULT|HEALTH_TOF_FAULT|HEALTH_I2C_FAULT)) return UAVCAN_PROTOCOL_NODESTATUS_HEALTH_ERROR;
